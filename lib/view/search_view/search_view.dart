...
class _EventCategoryScreenState extends State<EventCategoryScreen> {
  final List<Category> categories = [
    Category("Music",
        "https://ciac.uiu.ac.bd/wp-content/uploads/2018/08/austin-neill-247047-unsplash.jpg"),
    Category("Sport",
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQujYgGA83X-bf70YeHs5PPzJCP107naLymbg&s"),
    Category("Festivals",
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbB14Z-rV5i2EHhz61PgqLVl4a0_BJhTcArg&s"),
    ...
    Category("Nightlife",
        "https://ciac.uiu.ac.bd/wp-content/uploads/2018/08/austin-neill-247047-unsplash.jpg"),
    Category("Food & Drink",
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_4y-42Isg1bbcN-2wfhw2YwpNMSgkJkWSXg&s"),
  ];
            ...
            children: [
              ...
              Expanded(
                child: filteredCategories.isEmpty
                    ? Center(
                        child: NotFoundWidget(message: "No Search Result Found")
                      )
                    : GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            onTap: () {
                              Get.to(() => SearchDetailsPage(
                                    tag: filteredCategories[index]
                                        .name
                                        .toLowerCase(),
                                  ));
                            },
