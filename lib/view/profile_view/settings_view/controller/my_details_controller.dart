...
class UpdateProfileController extends GetxController {
  ...
  Future<void> updateProfile({required String firstName, required String userName, required String bio, File? profilePicture}) async {
    try {
      isLoading(true);
      ...
      if (profilePicture != null) {
        request.files.add(await http.MultipartFile.fromPath('profilePicture', profilePicture.path, filename: profilePicture.path.split('/').last));
      }

      request.fields.addAll({"firstName": firstName, "lastName": userName, "bio": bio});
